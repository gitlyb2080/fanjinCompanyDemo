...
jQuery.fn.extend(
{
    OpenDiv: function()
    {
        ...
        var sWidth, sHeight;
        sWidth = window.screen.availWidth-1;
        ...
        $("html").css("overflow-y", "auto");/*12.11ÐÞ¸Ä Ô­:$("html").css("overflow", "hidden");*/
        ...
        var Div_topposition = top + (height / 2) - 480;//var Div_topposition = top + (height / 2) - (MyDiv_h / 2); Ô­
    ...
    , CloseDiv: function()
    {
        ...
        //window.scrollTo($("#BigDiv").attr("divbox_scrollleft"), $("#BigDiv").attr("divbox_scrolltop"));
        //$("#BigDiv").data("divbox_selectlist").show();//2.2×¢ÊÍ
        $("#BigDiv").remove();
